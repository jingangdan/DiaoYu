...
public class ImageRecyclerAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private ArrayList<View> listV = new ArrayList<>();
    private ArrayList<SuperCheckBox> listCB = new ArrayList<>();

    private boolean isClickCamere;
    ...
    private class ImageViewHolder extends ViewHolder {
        ...
        void bind(final int position) {
         ...
         /*   for (ImageItem item : imagePicker.getSelectedImages()) {
                if (imageItem.path.equals(item.path)){
                    mask.setVisibility(View.VISIBLE);
                    cbCheck.setChecked(true);
                }  else {
                    mask.setVisibility(View.GONE);
    ...
    public boolean isClickCamere() {
        return isClickCamere;
    }
}
