...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.d("8888", "---fileName---" +  file.getAbsolutePath());
            Toast.makeText(ImagePreviewBaseActivity.this, "文件存储在："+file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
//            Toast.makeText(ImagePreviewBaseActivity.this, "保存成功", Toast.LENGTH_SHORT).show();
        }
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //保存按钮
        save = (TextView) findViewById(R.id.preview_tv_save);
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("8888", "---fileName---" + str[str.length-1]);
                        Log.d("8888", "---url---" + url);

                        file = Utils.savePicture(ImagePreviewBaseActivity.this,Utils.getHttpBitmap(url),str[str.length-1]);
