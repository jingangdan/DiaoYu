...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    public static boolean isShowNum = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit = this.getIntent().getBooleanExtra("edit", true);
        isShowNum = this.getIntent().getBooleanExtra("isShowNum", true);
        isSave = this.getIntent().getBooleanExtra("isSave", false);
