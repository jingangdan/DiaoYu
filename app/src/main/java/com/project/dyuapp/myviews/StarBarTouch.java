...
public class StarBarTouch extends View {
    ...
    public StarBarTouch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public StarBarTouch(Context context, AttributeSet attrs, int defStyleAttr) {
