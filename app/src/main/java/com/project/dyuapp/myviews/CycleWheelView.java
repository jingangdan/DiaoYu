...
/**
 * Created by
 * http://www.jb51.net/article/88669.htm
 * 时间选择器控件
 * 可循环滚动的选择器
 */
public class CycleWheelView extends ListView {
    ...
    private static final int COLOR_DIVIDER_DEFALUT = Color.parseColor("#269ceb");
    private static final int HEIGHT_DIVIDER_DEFAULT =2;
    private static final int COLOR_SOLID_DEFAULT = Color.parseColor("#00000000");
    private static final int COLOR_SOLID_SELET_DEFAULT = Color.parseColor("#00000000");
    ...
    /**
     * Color Of Selected Label 选中字体颜色
     */
    private int mLabelSelectColor = Color.parseColor("#333333");

    /**
     * Color Of Unselected Label 未选中字体颜色
     */
    private int mLabelColor = Color.parseColor("#999999");
    ...
    /**
     * Color of Selected Solid 选定的固定颜色
     */
    ...
    public int getSelection() {
        ...
        try {
            if (mLabels != null){
                if (mLabels.size() != 0  && (mCurrentPositon - mWheelSize / 2)!=0){
