...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.banner_sel_radius;
    private int mIndicatorUnselectedResId = R.drawable.banner_unsel_radius;
    private int mIndicatorAnimatorResId = R.anim.banner_scale_with_alpha;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorAnimatorResId = typedArray.getResourceId(R.styleable.Banner_indicator_animator, mIndicatorAnimatorResId);
    ...
    public void setBannerTitle(String[] titles) {
        ...
        if (bannerStyle == CIRCLE_INDICATOR_TITLE || bannerStyle == NUM_INDICATOR_TITLE) {
            if (titles != null && titles.length > 0) {
                ...
                numIndicator.setBackgroundResource(R.drawable.banner_black_background);
            }
        }
    }
    ...
    public void onPageSelected(int position) {
        for (int i = 0; i < indicatorImages.size(); i++) {
            ...
            } else if (position > indicatorImages.size()) {
                if (i == 0) {
                    mIndicator.setImageResource(mIndicatorSelectedResId);
                } else {
