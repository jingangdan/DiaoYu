 ...
 *
 * @description 抽屉显示类型列表适配器
 * @change
 */


public class DrawerShowTypeListAdapter extends MyCommonAdapter<DrawerListBean> {
    ...
    public DrawerShowTypeListAdapter(List<DrawerListBean> list, Context mContext, int resid) {
