...
public class PublishPostAdapter2 extends BaseAdapter {
    ...
    public PublishPostAdapter2(List<ContentBean> list, Context mContext, PostEditCallBack callBack) {
        this.list = list;
        this.mContext = mContext;
        this.callBack = callBack;
    }

    public PublishPostAdapter2(List<ContentBean> list, Context mContext, PostEditCallBack callBack, boolean firstIsCanDel) {
        this.list = list;
        this.mContext = mContext;
        this.callBack = callBack;
