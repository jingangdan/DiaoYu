 ...
 *
 * @description 抽屉类型列表适配器
 * @change
 */


public class DrawerModelListAdapter extends MyCommonAdapter<DrawerListBean> {
    ...
    public DrawerModelListAdapter(List<DrawerListBean> list, Context mContext, int resid) {
