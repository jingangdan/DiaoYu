 ...
 *
 * @description 抽屉收费列表适配器
 * @change
 */


public class DrawerCostListAdapter extends MyCommonAdapter<DrawerListBean> {
    ...
    public DrawerCostListAdapter(List<DrawerListBean> list, Context mContext, int resid) {
