...
public class GlideUtils {
    ...
    public static void loadImageView(Context mContext, String path, ImageView mImageView) {
        Glide.with(mContext).load(path).placeholder(R.mipmap.mine_img).error(R.mipmap.mine_img).into(mImageView);
    }
    //头像
    public static void loadImageViewHead(Context mContext, String path, ImageView mImageView) {
        Glide.with(mContext).load(path).placeholder(R.mipmap.mine_edit_head).into(mImageView);
    }
    public static void loadImageViewNo(Context mContext, String path, ImageView mImageView) {
        Glide.with(mContext).load(path).error(R.mipmap.mine_edit_head).into(mImageView);
    }
    //加载指定大小
